...
import { PALWORLD_ADAPTER_SPEC } from "@/features/adapters/palworld/spec";
import { RTM_ADAPTER_SPEC } from "@/features/adapters/rtm/spec";
...
export const ADAPTERS = {
  ...
  palworld: PALWORLD_ADAPTER_SPEC,
